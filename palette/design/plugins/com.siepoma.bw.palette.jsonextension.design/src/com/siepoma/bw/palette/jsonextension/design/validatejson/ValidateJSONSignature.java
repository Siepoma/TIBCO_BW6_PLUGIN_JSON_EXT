...
import com.siepoma.bw.palette.jsonextension.design.JsonExtensionExceptionsSchema;
 ...
 * 
 */
public class ValidateJSONSignature extends BWActivitySignature 
{
	...
	*/
    ...
    public XSDElementDeclaration getInputType(final Configuration config) {
        ...
        inputType =  ValidateJSONSchema.getInputType(); 
  			// begin-custom-code
  			// add your own business code here
  			// end-custom-code
        return inputType;
	...
	*/
    ...
    public XSDElementDeclaration getOutputType(final Configuration config) {
        ...
        outPutType =  ValidateJSONSchema.getOutputType();
  			// begin-custom-code
  			// add your own business code here
  			// end-custom-code
        return outPutType;
    ...
    public List<XSDElementDeclaration> getFaultTypes(final Configuration config) {
        ...
        faultType =  JsonExtensionExceptionsSchema.getJsonExtensionPluginFaultTypes();
			// begin-custom-code
			// add your own business code here
			// end-custom-code
		return faultType;
